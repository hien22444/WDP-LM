...
exports.login = async (req, res) => {
  try {
    ...
    if (user.status !== "active") {
      ...
      if (user.status === "blocked") msg = "Your account has been blocked. Please contact support.";
      if (user.status === "banned") msg = "Your account has been permanently banned. You cannot log in.";
