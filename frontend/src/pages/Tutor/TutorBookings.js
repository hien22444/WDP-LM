...
const TutorBookings = () => {
  ...
  const load = async () => {
    ...
    try {
      ...
      console.log("💰 Filtered paid bookings:", paidBookings.length, "out of", bookings.length);
    ...
    <div style={{ padding: "24px", maxWidth: "1400px", margin: "0 auto" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
                    ...
                    <span style={{
                      ...
                      fontSize: "12px",
                      fontWeight: "600",
                      background: b.status === "pending" ? "#FEF3C7" : b.status === "accepted" ? "#D1FAE5" : "#F3F4F6",
                      color: b.status === "pending" ? "#92400E" : b.status === "accepted" ? "#065F46" : "#374151"
                    }}>
                      {b.status === "pending" ? "⏳ Chờ duyệt" : b.status === "accepted" ? "✅ Đã chấp nhận" : b.status}
                    </span>
                    <span style={{
                      padding: "4px 12px",
                      borderRadius: "16px",
                  ...
                  {b.type === "recurring" && (
                    <div style={{ marginTop: "12px", padding: "12px", background: "#F0F9FF", borderRadius: "8px", border: "1px solid #BFDBFE" }}>
                      ...
                      <div style={{ fontSize: "14px", color: "#1E3A8A", marginBottom: "4px" }}>
                        <strong>Lịch trong tuần:</strong> {formatRecurringSchedule(b) || "Chưa có lịch"}
                      </div>
                      <div style={{ fontSize: "14px", color: "#1E3A8A" }}>
                        <strong>Tổng buổi:</strong> {b.totalSessionsPlanned || 0} buổi · <strong>Hoàn thành:</strong> {b.completedSessions || 0} buổi
                      </div>
                    </div>
                  )}
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "12px", marginTop: "12px" }}>
                    <div>
                      <div style={{ fontSize: "12px", color: "#6B7280", marginBottom: "4px" }}>Hình thức</div>
                      <div style={{ fontSize: "14px", fontWeight: "500", color: "#374151" }}>
                        {b.mode === "offline" ? "📍 Trực tiếp" : "💻 Online"}
                      </div>
                    </div>
                    <div>
                      <div style={{ fontSize: "12px", color: "#6B7280", marginBottom: "4px" }}>Giá mỗi buổi</div>
                  ...
                  {b.notes && (
                    <div style={{ marginTop: "12px", padding: "10px", background: "#FFFBEB", borderRadius: "6px", borderLeft: "3px solid #F59E0B" }}>
                      <div style={{ fontSize: "12px", color: "#92400E", fontWeight: "600", marginBottom: "4px" }}>📝 Ghi chú:</div>
                      <div style={{ fontSize: "13px", color: "#78350F" }}>{b.notes}</div>
                    </div>
                  )}
                </div>
                ...
                <div style={{ display: "flex", gap: "8px", marginLeft: "20px" }}>
                  {b.status === "pending" ? (
                    <>
                      <button 
                        onClick={() => { setViewing(b); setShowContract(true); }}
                        style={{
                          padding: "10px 20px",
                          background: "#6366F1",
                          color: "white",
      ...
      {showContract && (
        <div
          ...
          onClick={() => { setShowContract(false); setViewing(null); setTutorSignature(""); }}
        >
          <div
            style={{
              background: "white",
          ...
          >
            ...
            <div style={{ 
              ...
              <p style={{ 
                ...
                {viewing?.type === "recurring" ? "Khóa học định kỳ" : "Buổi học đơn lẻ"}
              </p>
            </div>
              ...
              <>
                ...
                <div style={{ marginBottom: "24px" }}>
                  ...
                  <div style={{ 
                    ...
                    <div>
                      <div style={{ fontSize: "12px", color: "#6B7280", marginBottom: "6px", fontWeight: "600" }}>Họ và tên</div>
                      <div style={{ fontSize: "15px", color: "#111827", fontWeight: "500" }}>{viewing.contractData.studentName || viewing.student?.full_name || "—"}</div>
                    </div>
                    <div>
                      <div style={{ fontSize: "12px", color: "#6B7280", marginBottom: "6px", fontWeight: "600" }}>Điện thoại</div>
                      <div style={{ fontSize: "15px", color: "#111827", fontWeight: "500" }}>{viewing.contractData.studentPhone || "—"}</div>
                    </div>
                    <div>
                      <div style={{ fontSize: "12px", color: "#6B7280", marginBottom: "6px", fontWeight: "600" }}>Email</div>
                      <div style={{ fontSize: "15px", color: "#111827", fontWeight: "500" }}>{viewing.contractData.studentEmail || viewing.student?.email || "—"}</div>
                    </div>
                    <div style={{ gridColumn: "1 / -1" }}>
                      <div style={{ fontSize: "12px", color: "#6B7280", marginBottom: "6px", fontWeight: "600" }}>Địa chỉ</div>
                      <div style={{ fontSize: "15px", color: "#111827", fontWeight: "500" }}>{viewing.contractData.studentAddress || "—"}</div>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ marginBottom: "24px" }}>
                  ...
                  <div style={{ 
                    ...
                    <div>
                      <div style={{ fontSize: "12px", color: "#4338CA", marginBottom: "6px", fontWeight: "600" }}>Môn học</div>
                      <div style={{ fontSize: "15px", color: "#1E1B4B", fontWeight: "600" }}>{viewing.contractData.subject || "—"}</div>
                    </div>
                    <div>
                      <div style={{ fontSize: "12px", color: "#4338CA", marginBottom: "6px", fontWeight: "600" }}>Số buổi</div>
                      <div style={{ fontSize: "15px", color: "#1E1B4B", fontWeight: "600" }}>{viewing.totalSessionsPlanned || viewing.contractData.totalSessions || 1} buổi</div>
                    </div>
                    <div>
                      <div style={{ fontSize: "12px", color: "#4338CA", marginBottom: "6px", fontWeight: "600" }}>Thời lượng/buổi</div>
                      <div style={{ fontSize: "15px", color: "#1E1B4B", fontWeight: "600" }}>{viewing.contractData.sessionDuration || 60} phút</div>
                    </div>
                    <div>
                      <div style={{ fontSize: "12px", color: "#4338CA", marginBottom: "6px", fontWeight: "600" }}>Hình thức</div>
                      <div style={{ fontSize: "15px", color: "#1E1B4B", fontWeight: "600" }}>{viewing.mode === "offline" ? "📍 Trực tiếp" : "💻 Online"}</div>
                    </div>
                  </div>
                </div>

                {/* Lịch trình */}
                {viewing.type === "recurring" && viewing.recurrencePattern?.selectedSlots && (
                  <div style={{ marginBottom: "24px" }}>
                    <h3 style={{ 
                      fontSize: "18px", 
                      fontWeight: "700", 
                    ...
                    <div style={{ 
                      ...
                      <div style={{ marginBottom: "12px" }}>
                        <span style={{ fontSize: "13px", color: "#065F46", fontWeight: "600" }}>Thời gian: </span>
                        <span style={{ fontSize: "14px", color: "#047857" }}>
                          {(() => {
                            const startDate = viewing.recurrencePattern.startDate;
                      ...
                      <div style={{ fontSize: "13px", color: "#065F46", fontWeight: "600", marginBottom: "8px" }}>Lịch trong tuần:</div>
                      <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                        {viewing.recurrencePattern.selectedSlots.map((slot, idx) => (
                          <div key={idx} style={{
                            background: "#10B981",
                            color: "white",
                            padding: "8px 16px",
                ...
                <div style={{ marginBottom: "24px" }}>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                      <div>
                        <div style={{ fontSize: "13px", color: "#92400E", marginBottom: "6px", fontWeight: "600" }}>Giá mỗi buổi</div>
                        <div style={{ fontSize: "20px", color: "#78350F", fontWeight: "700" }}>{(viewing.price || 0).toLocaleString()} đ</div>
                      </div>
                      <div>
                        <div style={{ fontSize: "13px", color: "#92400E", marginBottom: "6px", fontWeight: "600" }}>Tổng thanh toán</div>
                        <div style={{ fontSize: "24px", color: "#DC2626", fontWeight: "700" }}>{(viewing.totalPrice || viewing.price || 0).toLocaleString()} đ</div>
                      </div>
                    </div>
                    <div style={{ 
                      marginTop: "12px", 
            ...
            {viewing?.status === "pending" && (
              <div style={{ 
                ...
                <p style={{ fontSize: "14px", color: "#075985", marginBottom: "16px" }}>
              ...
              {viewing?.status === "pending" && (
                <button
                  ...
                  style={{ 
                    ...
                    cursor: tutorSignature.trim() ? "pointer" : "not-allowed",
                    transition: "all 0.3s",
                    boxShadow: tutorSignature.trim() ? "0 4px 12px rgba(102, 126, 234, 0.4)" : "none"
                  }}
                  onMouseEnter={(e) => {
                    if (tutorSignature.trim()) {
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.target.style.boxShadow = tutorSignature.trim() ? "0 4px 12px rgba(102, 126, 234, 0.4)" : "none";
                  }}
                >
