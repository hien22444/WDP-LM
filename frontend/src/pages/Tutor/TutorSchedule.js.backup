                ...
                {getWeekDays().map((day, dayIndex) => (
                  <div key={dayIndex} className="day-column">
                    {getTimeSlots().map((time) => {
                      ...
                      const openSlot = booking
                        ? null
                        : getOpenSlotForTime(day, time);
                      return (
                        <div
                          key={time}
                          className={`calendar-cell ${
                            booking ? "has-booking" : openSlot ? "has-slot" : ""
                          }`}
                          onClick={() =>
                            booking
                              ? setSelectedBooking(booking)
                              : openSlot && setSelectedSlot(openSlot)
                          }
                        >
                          {booking && (
                            <div
                          ...
                          {!booking && openSlot && (
                            <div
                              className="slot-item"
                              title={`${openSlot.courseName} — ${
                                openSlot.mode === "online"
                                  ? "Trực tuyến"
                                  : openSlot.location || ""
                              }`}
                            ...
                            >
                              ...
                              <div className="booking-status">Slot mở</div>
                            </div>
                          )}
                        </div>
                      );
            ...
            <div className="modal-body">
              <div className="booking-details">
                ...
                <div className="detail-row">
                  <span className="label">Hình thức:</span>
                  <span className="value">
                    {selectedSlot.mode === "online" ? "Trực tuyến" : "Tại nhà"}
                  </span>
                </div>
                ...
                <div className="detail-row">
                  ...
                  <span className="value">
                    {(selectedSlot.price || 0).toLocaleString()} VNĐ
                  </span>
                </div>
                <div className="detail-row">
