...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route 
        path="/admin" 
        element={isAuthenticated && userRole === 'admin' ? <AdminLayout /> : <Navigate to="/" />} 
      >
      ...
      <Route element={<MainLayout />}>
        ...
        <Route 
          path="/tutor/publish" 
          element={isAuthenticated ? <TutorPublishSlot /> : <Navigate to="/" />} 
        />
        <Route 
          path="/dashboard" 
        ...
        <Route 
          path="/bookings/me" 
          element={isAuthenticated ? <StudentBookings /> : <Navigate to="/" />} 
        />
        <Route 
          path="/tutor/schedule" 
