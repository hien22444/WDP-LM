          ...
          <div className="parties-grid">
            <div className="party-card student">
              ...
              <div className="party-info">
                <p>
                  <strong>Họ tên:</strong> {contractData.studentName}
                </p>
                <p>
                  <strong>Số điện thoại:</strong> {contractData.studentPhone}
                </p>
                <p>
                  <strong>Email:</strong> {contractData.studentEmail}
                </p>
                <p>
                  <strong>Địa chỉ:</strong> {contractData.studentAddress}
                </p>
              </div>
            </div>
            <div className="party-card tutor">
              ...
              <div className="party-info">
                <p>
                  <strong>Họ tên:</strong> {tutor?.name}
                </p>
                <p>
                ...
                <p>
                  <strong>Bằng cấp:</strong> {tutor?.qualification}
                </p>
                <p>
            ...
            <div className="party-card platform">
              ...
              <div className="party-info">
                <p>
                  <strong>Tên:</strong> LearnMate
                </p>
                <p>
                  <strong>Địa chỉ:</strong> Việt Nam
                </p>
                <p>
                  <strong>Email:</strong> support@learnmate.com
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="course-section">
          ...
          <div className="course-info">
            <div className="info-grid">
              ...
              {contractData.weeklySchedule &&
                contractData.weeklySchedule.length > 0 && (
                  <div className="info-item">
            ...
            <div className="financial-grid">
              <div className="financial-item">
                ...
                <span className="price">
                  {contractData.pricePerSession?.toLocaleString()}đ
                </span>
              </div>
              <div className="financial-item">
                <span className="label">Số buổi học:</span>
              ...
              <div className="financial-item total">
                ...
                <span className="price">
                  {contractData.totalPrice?.toLocaleString()}đ
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="terms-section">
          ...
          <div className="terms-content">
            <div className="term-item">
              ...
              <p>
                Học viên cam kết tham gia đầy đủ {contractData.totalSessions}{" "}
                buổi học, mỗi buổi 2 giờ 30 phút, hình thức{" "}
                {contractData.mode === "online" ? "trực tuyến" : "trực tiếp"}.
              </p>
            </div>
            ...
            <div className="term-item">
              ...
              <ul>
                <li>
                  <strong>Nghỉ tạm thời:</strong> Thông báo trước 24h, không
                  tính phí
                </li>
                <li>
                  <strong>Nghỉ dài hạn:</strong> Thông báo trước 48h, phí bảo
                  lưu 15%/tháng
                </li>
                <li>
                  <strong>Hủy trước 24h:</strong> Hoàn 100% tiền
                </li>
                <li>
                  <strong>Hủy trong 24h:</strong> Hoàn 50% tiền
                </li>
                <li>
                  <strong>Hủy sau khi bắt đầu:</strong> Hoàn 0% tiền
                </li>
              </ul>
            </div>
            ...
            <div className="term-item">
              ...
              <p>
                Mọi tranh chấp sẽ được giải quyết bằng thương lượng, trung gian
                hòa giải, hoặc tòa án có thẩm quyền theo luật Việt Nam.
              </p>
            </div>
            ...
            <div className="term-item">
              ...
              <p>
                Hợp đồng có hiệu lực từ ngày ký đến khi hoàn thành khóa học. Các
                bên cam kết bảo mật thông tin cá nhân và tuân thủ các điều khoản
                đã thỏa thuận.
              </p>
            </div>
          </div>
          ...
          <div className="signature-grid">
            ...
            <div className="signature-item">
              ...
              <div className="signature-line">
                ...
                >
                  {tutor?.name ||
                    tutor?.user?.profile?.full_name ||
                    tutor?.user?.email ||
                    "[Chờ gia sư chấp nhận booking]"}
                </div>
              </div>
              <div className="signature-date">
