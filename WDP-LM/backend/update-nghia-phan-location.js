...
async function updateNghiaPhanLocation() {
  try {
    ...
    const updateData = {
      city: 'Hồ Chí Minh',
      district: 'Quận 1',
      bio: 'Gia sư Toán với 2 năm kinh nghiệm, chuyên dạy Toán cấp 2 và cấp 3.',
      subjects: [
    ...
    console.log('\n✅ Đã cập nhật thông tin TutorProfile:');
    ...
    console.log('\n🎉 Cập nhật thành công! Bây giờ Nghia Phan đã có địa chỉ.');
  } catch (error) {
    console.error('Error:', error.message);
  }
}

updateNghiaPhanLocation();
